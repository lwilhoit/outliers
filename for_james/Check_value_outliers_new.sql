/* The procedure in this script, PROCEDURE Check_value_outliers_new(),
	replaces PROCEDURE Check_value.Outliers() in Check_value package.
   However, there is now no need to use the ai_cur cursor.
