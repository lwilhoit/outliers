...
/*
SELECT	chem_code, site_general, regno_short, ag_ind, unit_treated, COUNT(*)
FROM		ai_group_nonag_stats
GROUP BY chem_code, site_general, regno_short, ag_ind, unit_treated
HAVING	COUNT(*) > 1;
